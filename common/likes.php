...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h3 class="mt-4">Liked By Users</h3>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item">Business</li>
                <li class="breadcrumb-item active">Liked By Users</li>
            </ol>
                            ...
                            <tbody>
                                <?php
                                    if($_SESSION['bu_type']=='1'){
                                        $execute = mysqli_query($b_connect, "SELECT * from business, likes,b_users  WHERE b_users.bu_id = likes.e_u_id AND business.b_id = likes.b_id ORDER BY likes.l_id DESC"); 
                                    } else {
                                        $u_id = $_SESSION['bu_id'];
                                        $execute = mysqli_query($b_connect, "SELECT * from business, likes,b_users  WHERE b_users.bu_id = likes.e_u_id AND business.b_id = likes.b_id AND business.u_id = '$u_id' ORDER BY likes.l_id DESC"); 
                                    }
                                    $count = '1';
