...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Interested Businesses By Investors</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item">Business</li>
                <li class="breadcrumb-item active">View Interested Businesses By Investors</li>
            </ol>
                        ...
                        <table id="table" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $u_id = $_SESSION['bu_id'];
                                    $execute = mysqli_query($b_connect, "SELECT * from business, interested_users,b_users  WHERE b_users.bu_id = interested_users.inv_u_id AND business.b_id = interested_users.b_id ORDER BY iu_id DESC"); 
