        ...
        <div class="col-md-6 col-sm-6">
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <img class="d-block w-100" src="images/about1.jpg" alt="Third slide">
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 align-self-center">
                                ...
                                <h1 class="mb-4">#1 Place To Find The Perfect
                                    Business Ideas</h1>
                                <p class="mb-4">"The premier destination for investors and entrepreneurs, our website is a dynamic platform that connects visionaries with capital. Discover a vast network of potential partners, investors, and opportunities. Whether you're seeking funding for your startup or looking to invest in innovative ventures, we provide the essential resources and connections to propel your business endeavors to new heights. Join us today and embark on a journey of growth and success."</p>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
                    <div class="team-item rounded overflow-hidden">
                        <div class="position-relative">
                            ...
                            <img class="img-fluid" src="images/male_prof.jpg" alt="member">
                            </p>
                        ...
                        <div class="text-center p-4 mt-3">
                            <h5 class="fw-bold mb-0">FEBIN</h5>
                            <small>febin@gmail.com</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
                    <div class="team-item rounded overflow-hidden">
                        <div class="position-relative">
                            ...
                            <p id="rcorners1" class="text-center">
                            <img class="img-fluid" src="images/fem_prof.jpg"alt="member">
                            </p>
                            <!-- <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                                <a class="btn btn-square mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square mx-1" href=""><i class="fab fa-twitter"></i></a>
                        ...
                        <div class="text-center p-4 mt-3">
                            <h5 class="fw-bold mb-0">SARITHA</h5>
                            <small>saritha@gmail.com</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
                    <div class="team-item rounded overflow-hidden">
                        <div class="position-relative">
                            ...
                            <p id="rcorners1" class="text-center">
                            <img class="img-fluid" src="images/male_prof1.jpg" alt="member">
                            </p>
                            <!-- <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                                <a class="btn btn-square mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square mx-1" href=""><i class="fab fa-twitter"></i></a>
                        ...
                        <div class="text-center p-4 mt-3">
                            <h5 class="fw-bold mb-0">ALWIN</h5>
                            <small>alwin@gmail.com</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
                    <div class="team-item rounded overflow-hidden">
                        <div class="position-relative">
                            ...
                            <p id="rcorners1" class="text-center">
                                <img class="img-fluid" src="images/fem_prof1.jpg" alt="member" >
                            </p>
                            <!-- <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                                <a class="btn btn-square mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square mx-1" href=""><i class="fab fa-twitter"></i></a>
                        ...
                        <div class="text-center p-4 mt-3">
                            <h5 class="fw-bold mb-0">PARVATHI</h5>
                            <small>parvathi@gmail.com</small>
                        </div>
                    </div>
                </div>
